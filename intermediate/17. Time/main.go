...
func main() {
	...
	// Specific time
	specificTime := time.Date(2025, time.May, 14, 19, 48, 0, 0, time.UTC)
	fmt.Println("Specific time:", specificTime)

	// Go uses "Mon Jan 2 15:04:05 MST 2006" as reference time
	// Parse time (layout & value string)
	parsedTime1, _ := time.Parse("2006-01-02", "2020-05-01")
	parsedTime2, _ := time.Parse("06-01-02", "20-05-01")
	parsedTime3, _ := time.Parse("06-1-2", "20-5-1")
	parsedTime4, _ := time.Parse("06-1-2 15-04", "20-5-1 18-03")
	fmt.Println(parsedTime1) // 2020-05-01 00:00:00 +0000 UTC
	fmt.Println(parsedTime2) // 2020-05-01 00:00:00 +0000 UTC
	fmt.Println(parsedTime3) // 2020-05-01 00:00:00 +0000 UTC
	fmt.Println(parsedTime4) // 2020-05-01 18:03:00 +0000 UTC
